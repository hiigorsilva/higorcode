...
export const HeroSection = () => {
	return (
		<section className="min-h-dvh w-full flex justify-center items-center py-10 px-5">
			<div className="max-w-2xl w-full flex flex-col items-center gap-8">
				...
				{/* MORE CONTENT ICON */}
				<a href="/" className="flex flex-col items-center gap-1 pt-10">
					<MouseIcon className="text-muted-foreground animate-bounce" />
					<span className="font-light text-xs text-foreground uppercase">
						Ver mais
					</span>
				</a>
			</div>
